...
public class TdlParser extends AbstractAntlrParser {
	...
	@Override
	protected InternalTdlParser createParser(XtextTokenStream stream) {
		return new InternalTdlParser(stream, getGrammarAccess());
	}
