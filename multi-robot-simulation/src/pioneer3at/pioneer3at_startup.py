...
if __name__ == '__main__':
    ...
    subprocess.Popen("export ROS_MASTER_URI=http://" + message[1] + ":11311; export ROS_IP=" + robot_status_table.get("robot_ip_address") + "; export ROS_HOSTNAME=" + robot_status_table.get("robot_ip_address") + "; roslaunch multi-robot-simulation pioneer3at.launch", shell=True).wait()
